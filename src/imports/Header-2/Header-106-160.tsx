import svgPaths from "./svg-qlzkjys9tb";
  ...
  return (
    <div className="absolute inset-[3.56%_0.85%_0.12%_0.07%]">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 58.4609 21.1898">
        <g id="Group 10">
          <path d={svgPaths.p28a018f0} fill="var(--fill-0, white)" id="Vector" />
          <path d={svgPaths.p8d2bd00} fill="var(--fill-0, white)" id="Vector_2" />
          <path d={svgPaths.p18bc3d80} fill="var(--fill-0, white)" id="Vector_3" />
          <path d={svgPaths.p2a4e8600} fill="var(--fill-0, white)" id="Vector_4" />
          <path d={svgPaths.p33538d80} fill="var(--fill-0, white)" id="Vector_5" />
          <path d={svgPaths.p8a17000} fill="var(--fill-0, white)" id="Vector_6" />
          <path d={svgPaths.p3f459a00} fill="var(--fill-0, white)" id="Vector_7" />
          <path d={svgPaths.p1bd87480} fill="var(--fill-0, white)" id="Vector_8" />
          <path d={svgPaths.p15a4b200} fill="var(--fill-0, white)" id="Vector_9" />
          <path d={svgPaths.p19981a80} fill="var(--fill-0, white)" id="Vector_10" />
        </g>
      </svg>
    </div>
  );
...
function Link1() {
  return (
    <div className="bg-[#101828] h-[40px] relative rounded-[10px] shrink-0 w-[120.213px]" data-name="Link">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
